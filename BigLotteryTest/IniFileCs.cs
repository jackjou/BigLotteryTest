...
public class IniFile
{
    ...
    // Loads the Reads the data in the streamreader into the IniFile object
    public void Load(StreamReader oReader)
    {
        Load(oReader, false);
    }

    // Loads the Reads the data in the streamreader into the IniFile object
    public void Load(StreamReader oReader, bool bMerge)
    {
        if (!bMerge)
        {
            RemoveAllSections();
